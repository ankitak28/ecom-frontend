        ...
        <div className="md:w-36 sm:w-24">
          ...
          <div className="flex items-start gap-5 mt-3">
            <button
              ...
              className="flex items-center font-semibold space-x-2 px-4 py-1 text-xs border border-rose-600 rounded-md hover:bg-red-50 transition-colors duration-500"
            >
