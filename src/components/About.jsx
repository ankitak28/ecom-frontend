      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-12 ">
        <div className="w-full md:w-1/2 text-center md:text-left">
          <p className="text-lg mb-4">
            We're thrilled to have you here! Our eCommerce platform is designed
            with you in mind—bringing you a smooth, secure, and enjoyable
            shopping experience. Whether you're looking for the latest trends,
            everyday essentials, or special finds, we’ve made it easy to browse,
            shop, and order—all from the comfort of your home. Thank you for
