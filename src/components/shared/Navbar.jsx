        ...
        >
          ...
          {user && user.id ? (
            ...
            <li className="font-[500] transition-all duration-150">
              ...
              bg-gradient-to-r from-purple-600 to-red-500 text-white font-semibold
              rounded-mg shadow-lg hover:from-purple-500 hover:to-red-400 transition duration-300
